...
const RecentArticleCard = ({ article }: RecentArticleCardProps) => {
  ...
  return (
    <div
      ...
      className="relative cursor-pointer col-span-3 md:col-span-1 flex flex-col gap-2 w-full p-4 hover:-translate-y-2 transition duration-200 ease-in bg-white rounded-2xl"
    >
