...
const ArticleCard = ({
    ...
    return (
        <div className="w-full h-full flex flex-row gap-4 p-8 bg-white hover:scale-105 transition duration-200 ease-in-out shadow-sm rounded-lg">
            <div className="w-full h-full flex flex-col md:flex-row gap-4">
                <div className="w-full h-full flex flex-row justify-center items-center gap-4">
                    ...
                    <div className='relative w-1/3 h-[12dvh] md:h-[20dvh] rounded-2xl overflow-hidden bg-primary-600'>
                        <Image
